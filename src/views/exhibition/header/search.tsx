...
const Search = () => {
    ...
    return <div className="grid content-center w-5/6 md:w-1/2 h-24 mx-auto mt-10 mb-8">
        <div className="relative w-5/6 mx-auto">
            <input type="text" value={searchKeyWord} placeholder="try to input：p|l|r|c|m" onChange={(e) => { action(changeSearchKeyWords(e.target.value)) }} className="w-full h-12 pl-8 pr-12 sm:pr-16  rounded-2xl text-neutral-700 font-semibold" ref={inputRef} onKeyDown={(e) => e.key === "Enter" && navigateLoading()} />
