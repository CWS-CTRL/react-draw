...
const MR00 = ({ options = {} }: SVGProps) => {
    const { size = 60, color = "#ffffff", stroke = 0.1, dur = 2, svgRef } = options;
    ...
    return <svg width={size} height={size} xmlns="http://www.w3.org/2000/svg" viewBox="13 18 75 75" ref={svgRef}>
        <g id={getExclusiveId("bicycle")} fill="none" stroke={color}>
            <g id={getExclusiveId("whell")} strokeWidth={5 * stroke}>
                <g id={getExclusiveId("left-whell")}>
                    <circle cx="30" cy="60" r="10" />
                    <circle cx="30" cy="60" r="0.5" />
                    <g id={getExclusiveId("spoke")} strokeWidth={1 * stroke}>
            ...
            <g id={getExclusiveId("drive")} strokeWidth={3 * stroke}>
                ...
                <g id={getExclusiveId("pedal")}>
                    ...
                    <g id={getExclusiveId("before")}>
                        ...
                        <line id={getExclusiveId("p1")} x1="45" y1="65" x2="47" y2="65" strokeWidth={10 * stroke} strokeLinecap="round" />
                    </g>
                    <g id={getExclusiveId("after")}>
                        <line x1="46" y1="57" x2="46" y2="55" />
                        <line id={getExclusiveId("p2")} x1="45" y1="55" x2="47" y2="55" strokeWidth={10 * stroke} strokeLinecap="round" />
                    </g>
            ...
            <g id={getExclusiveId("frame")} strokeWidth={3 * stroke}>
                <line x1="30" y1="60" x2="43" y2="47" />
                <line x1="46" y1="57" x2="42" y2="44" strokeWidth={4 * stroke} />
                <line x1="48.1" y1="57.9" x2="66" y2="45" strokeWidth={4 * stroke} />
                <line x1="70" y1="60" x2="64" y2="38" />
                <line x1="43" y1="47" x2="65" y2="43" />
                <line x1="66" y1="46" x2="65" y2="42" strokeWidth={10 * stroke} strokeLinecap="round" />
            </g>
            <g id={getExclusiveId("cushion")} fill={color} strokeWidth={3 * stroke}>
                <path d="M 39 44,l 7 -1,a 1 1 0 0 0  0 -2,l -6 -0.1,a 1.5 1.5 0 0 0 -1 3" />
            </g>
            <g id={getExclusiveId("head")} strokeWidth={4 * stroke}>
                <path d="M 64 38,q 2 0.5 4 0,q 5 -2 -4 -3" />
                <line x1="64" y1="35" x2="60" y2="34.5" strokeWidth={10 * stroke} strokeLinecap="round" />
            </g>
        </g>
    </svg>
}
