...
const CO00 = ({ options = {} }: SVGProps) => {
    const { size = 60, color = "#ffffff", stroke = 2, dur = 0.9, svgRef } = options;
    ...
    return <svg width={size} height={size} xmlns="http://www.w3.org/2000/svg" viewBox="35 35 30 30" ref={svgRef}>
        <g id={getExclusiveId("l")} fill={color} stroke={color} strokeWidth="0.1">
            <circle id={getExclusiveId("c1")} transform="rotate(0 50 50) translate(0 -10)" cx="50" cy="50" r={stroke} />
            <circle id={getExclusiveId("c2")} transform="rotate(40 50 50) translate(0 -10)" cx="50" cy="50" r={stroke} />
            <circle id={getExclusiveId("c3")} transform="rotate(80 50 50) translate(0 -10)" cx="50" cy="50" r={stroke} />
            <circle id={getExclusiveId("c4")} transform="rotate(120 50 50) translate(0 -10)" cx="50" cy="50" r={stroke} />
            <circle id={getExclusiveId("c5")} transform="rotate(160 50 50) translate(0 -10)" cx="50" cy="50" r={stroke} />
            <circle id={getExclusiveId("c6")} transform="rotate(200 50 50) translate(0 -10)" cx="50" cy="50" r={stroke} />
            <circle id={getExclusiveId("c7")} transform="rotate(240 50 50) translate(0 -10)" cx="50" cy="50" r={stroke} />
            <circle id={getExclusiveId("c8")} transform="rotate(280 50 50) translate(0 -10)" cx="50" cy="50" r={stroke} />
            <circle id={getExclusiveId("c9")} transform="rotate(320 50 50) translate(0 -10)" cx="50" cy="50" r={stroke} />
